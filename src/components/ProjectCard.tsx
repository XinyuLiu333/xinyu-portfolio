    ...
    <>
      <ViewTransition name={`hero-${project.slug}`}>
        ...
        >
          {hero ? (
            hero.padded ? (
              <div className="aspect-[16/9] flex items-center justify-center p-6 sm:p-10">
                <Image
                  src={hero.src}
                  alt={hero.alt}
                  width={1600}
                  ...
                  className={`w-[85%] h-auto rounded-md shadow-lg transition-transform duration-500 group-hover:scale-[1.03] ${locked ? "blur-[6px]" : ""}`}
                />
              </div>
            ) : (
              <Image
